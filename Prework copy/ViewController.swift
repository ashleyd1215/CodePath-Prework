...
//  Prework
//
//  Created by Ashley De Venuto on 8/21/22.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        UIView.animate(withDuration: 0.2, delay: 0.0, options: [.autoreverse,.repeat], animations: {() -> Void in self.dollarSign.transform = CGAffineTransform(translationX: 0, y: 2)}, completion: nil)
